        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DayNotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinanceInvestments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FinanceInvestments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallmentCurrent = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyLogs_Goals_GoalId",
                        column: x => x.GoalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedGoalGroups", x => new { x.GoalId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_SharedGoalGroups_Goals_GoalId",
                        column: x => x.GoalId,
                        principalTable: "Goals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SharedGoalGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StreakMilestones_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StreakMilestones_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreakCountAtTime = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StreakAchievements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StreakAchievements_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StreakAchievements_StreakMilestones_MilestoneId",
                        column: x => x.MilestoneId,
                        principalTable: "StreakMilestones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyLogs_GoalId_UserId_Date",
                table: "DailyLogs",
                columns: new[] { "GoalId", "UserId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinanceInvestments_UserId",
                table: "FinanceInvestments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedGoalGroups_GroupId",
                table: "SharedGoalGroups",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StreakAchievements_MilestoneId",
                table: "StreakAchievements",
                column: "MilestoneId");

            migrationBuilder.CreateIndex(
                name: "IX_StreakAchievements_UserId_MilestoneId",
                table: "StreakAchievements",
                columns: new[] { "UserId", "MilestoneId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StreakMilestones_CreatedByUserId",
                table: "StreakMilestones",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_StreakMilestones_GroupId",
                table: "StreakMilestones",
                column: "GroupId");
        }
